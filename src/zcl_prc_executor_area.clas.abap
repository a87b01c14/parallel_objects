class ZCL_PRC_EXECUTOR_AREA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_PRC_EXECUTOR_AREA' ##NO_TEXT.
  data ROOT type ref to ZCL_PRC_EXECUTOR_ACCESS read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_PRC_EXECUTOR_AREA
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to ZCL_PRC_EXECUTOR_ACCESS
    raising
...
CLASS ZCL_PRC_EXECUTOR_AREA IMPLEMENTATION.
